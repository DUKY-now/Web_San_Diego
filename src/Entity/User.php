...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function addUser(Ticket $user): static
    {
    ...
    public function removeUser(Ticket $user): static
    {
    ...
    public function addAuteur(Message $auteur): static
    {
    ...
    public function removeAuteur(Message $auteur): static
    {
